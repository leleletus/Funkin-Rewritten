...
return {
	...
	load = function(self)
		...
		if song == 4 then
			inst = love.audio.newSource("music/blazin/Inst.ogg", "stream")
			voices = love.audio.newSource("music/blazin/Voices.ogg", "stream")
		elseif song == 3 then
			inst = love.audio.newSource("music/2hot/Inst.ogg", "stream")
			voices = love.audio.newSource("music/2hot/Voices.ogg", "stream")
		elseif song == 2 then
			inst = love.audio.newSource("music/lit-up/Inst.ogg", "stream")
			voices = love.audio.newSource("music/lit-up/Voices.ogg", "stream")
		else
			inst = love.audio.newSource("music/darnell/Inst.ogg", "stream")
			voices = love.audio.newSource("music/darnell/Voices.ogg", "stream")
		end
