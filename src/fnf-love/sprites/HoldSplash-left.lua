return graphics.newSprite(
    love.graphics.newImage(graphics.imagePath("holdCoverPurple")),
    {
        -- start
        {x = 413, y = 96, width = 93, height = 93, offsetX = -111, offsetY = -107, offsetWidth = 300, offsetHeight = 400, rotated = false},
        -- loop
        {x = 407, y = 243, width = 108, height = 139, offsetX = -93, offsetY = -94, offsetWidth = 300, offsetHeight = 400, rotated = true},
        ...
        {x = 192, y = 243, width = 215, height = 185, offsetX = -47, offsetY = -55, offsetWidth = 300, offsetHeight = 400, rotated = false}, -- end0003
        {x = 192, y = 243, width = 215, height = 185, offsetX = -47, offsetY = -55, offsetWidth = 300, offsetHeight = 400, rotated = false}, -- end0004
        ...
        {x = 246, y = 0, width = 167, height = 243, offsetX = -52, offsetY = -113, offsetWidth = 300, offsetHeight = 400, rotated = true},  -- end0007
        {x = 246, y = 0, width = 167, height = 243, offsetX = -52, offsetY = -113, offsetWidth = 300, offsetHeight = 400, rotated = true},  -- end0008
    },
    {
