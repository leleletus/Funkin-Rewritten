...
local stage = require("stages.philly.stage")

local weekJSON = json.decode(love.filesystem.read("weeks/week3.json"))
...
return {
	...
	load = function(self)
		...
		inst   = love.audio.newSource("music/week3/" .. fileName .. "-inst.ogg",   "stream")
		voices = love.audio.newSource("music/week3/" .. fileName .. "-voices.ogg", "stream")
